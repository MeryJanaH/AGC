...
function update_table_emp()
{
  ...
  { ?>
    <tr>
        ...
        <td>
        <input type="button" id="susp" <?php if(check_susp($dn['ID_cm'])=="1"){ ?>value="Éliminer le suspend !"<?php } else {?> value="Suspendre !"<?php } ?> onClick=<?php if(check_susp($dn['ID_cm'])=="1"){ ?>'delete_susp<?php echo $dn['ID_cm'];?>()'<?php }
